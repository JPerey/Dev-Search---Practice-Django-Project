...
# <-- use this to direct from root path of project
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1",
                 "https://jperey-devsearch.herokuapp.com/", ".herokuapp.com"]
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            # <--- add your templates folder directory here!
